...
#    Updated: 2025/10/14 20:27:18 by sofernan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJ_DIR = obj
SRCS = process_input.c handle_incomplete_cmd.c prepare_segments.c exec_builtin_parent.c \
		handle_word_token.c init_glob.c split_loop_and_append.c execute_subshell.c \
		process_segment.c ft_cd.c execute_command.c ft_cmd.c expand_matches.c \
		process_and_exec.c execute_pipeline.c get_next_token_part.c tokenize_input.c \
		process_command.c extract_next_token.c main.c parse_commands.c parse_redir1.c parse_redir2.c \
